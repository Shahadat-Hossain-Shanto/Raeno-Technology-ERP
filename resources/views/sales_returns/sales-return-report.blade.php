                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h5 class="m-0"><strong><i class="fas fa-file-contract"></i>Sales Return Report</strong></h5>
                            </div>
                            <div class="card-body">
                                <div id="form_div">
        ...
        $(document).ready(function() {
            $('#customerReceiveReportForm').on('submit', function(e) {
               ...
               if (transaction_id !=''|| startdate.length != 0 && enddate.length != 0) {
                ...
                $.ajax({
                    type: "get",
                    url: "/sales-return-report/"+transaction_id+"/"+startdate+"/"+enddate+"/"+voucher,

                    success: function(response) {
                        // console.log(response.sales_return);
                        var totalDebit=0;
                        var totalCredit=0;
                        response.sales_return.forEach(customer_receive => {
                        ...
                        i=1;
                        $('#tablePart').show();
                        onChangeDataTable(response.sales_return,i)
