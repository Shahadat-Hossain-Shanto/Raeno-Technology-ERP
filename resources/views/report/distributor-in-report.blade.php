...
@section('title', 'Distributor Stock Report')
                ...
                <div class="col-lg-10">
                    ...
                    <div class="card card-primary shadow-sm">
                        <div class="card-header">
                            <h5 class="m-0">
                                <strong><i class="fas fa-file-contract"></i> Distributor Stock Report</strong>
                            </h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="tablePart" class="pt-3">
                                <div class="d-flex justify-content-between align-items-center pb-3">
                                    <h5 class="m-0"><strong>Distributor Stock Data</strong></h5>
                                    <div class="text-end">
...
<script>
    $(document).ready(function () {
        ...
        const table = $('#primaryInTable').DataTable({
            ajax: {
                url: '{{ route('distributor.in.report.data') }}',
                dataSrc: 'data',
                data: function (d) {
