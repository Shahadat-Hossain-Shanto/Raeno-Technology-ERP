                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary shadow-sm">
                        <div class="card-header">
                            <h5 class="m-0">
                                <strong><i class="fas fa-file-contract"></i> Primary In Report</strong>
                            </h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="tablePart" class="pt-3">
                                <div class="d-flex justify-content-between align-items-center pb-3">
                                    <h5 class="m-0"><strong>Primary-In History</strong></h5>
                                    <div class="text-end">
                                ...
                                <div class="table-responsive">
                                    <table id="primaryStockTable" class="table table-bordered table-striped">
...
<script>
    $(document).ready(function () {
        ...
        const table = $('#primaryStockTable').DataTable({
            ajax: {
                url: '{{ route('primary.stock.report.data') }}',
                dataSrc: 'data',
data: function (d) {
    ...
    console.log('Sent Data:', d); // ✅ Debug here
