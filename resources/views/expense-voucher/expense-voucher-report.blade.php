                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h5 class="m-0"><strong><i class="fas fa-file-contract"></i>Expense Voucher Report</strong></h5>
                            </div>
                            <div class="card-body">
                                <div id="form_div">
        ...
        $(document).ready(function() {
            $('#expenseVoucherReportForm').on('submit', function(e) {
               ...
               if (transaction_id !=''|| startdate.length != 0 && enddate.length != 0) {
                ...
                $.ajax({
                    type: "get",
                    url: "/expense-voucher-report/"+transaction_id+"/"+startdate+"/"+enddate+"/"+voucher,
