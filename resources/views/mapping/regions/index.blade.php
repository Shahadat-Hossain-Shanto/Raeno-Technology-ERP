...
@section('title', 'RAENO :: Region List')
        ...
        <div class="">
            <div class="card card-primary">
                <div class="card-header d-flex justify-content-between" style="height: 49px;">
                    <h5><strong><i class="fas fa-globe"></i> Region List</strong></h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="regionTable" class="table table-bordered table-striped dt-responsive nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Region Name</th>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="userMapModalLabel">RSM Users</h5>
...
<script>
        ...
        $('#regionTable').DataTable({
            ...
            columns: [
                ...
                { // New User Map Column
                    ...
                    render: function(row) {
                        return `
                            <button class="btn btn-info btn-sm user-map-btn" data-region-id="${row.id}">
                ...
                },
                {
                    ...
                    render: function(row) {
                        return `
                            <a href="/regions/${row.id}/edit" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                            <form action="/regions/${row.id}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
    ...
    $(document).on('click', '.user-map-btn', function () {
        ...
        $.ajax({
            url: `/regions/${regionId}/users`,
            method: 'GET',
            success: function (response) {
                let html = `
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <input type="text" class="form-control w-50" id="userSearchInput" placeholder="🔍 Search users...">
                        <button class="btn btn-success ms-3" id="bulkAssignBtn" data-region-id="${regionId}">
                ...
                if (response.users.length > 0) {
                    ...
                    html += '<tr><td colspan="6" class="text-center">No RSM users found for this region.</td></tr>';
                }
