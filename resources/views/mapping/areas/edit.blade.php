        ...
        <div class="container">
            <div class="card card-primary">
                <div class="card-header">
                    <h5><strong><i class="fas fa-map"></i> Edit Area</strong></h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('areas.update', $area->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="mb-2 col-lg-6">
                                ...
                                <select name="region_name" id="region_name" class="form-control" required>
                                    ...
                                    @foreach ($regions as $region)
                                        <option value="{{ $region->region_name }}" {{ $area->region_name == $region->region_name ? 'selected' : '' }}>
                                            {{ $region->region_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-2 col-lg-6">
                                ...
                                <input type="text" name="area_name" class="form-control" id="area_name" value="{{ $area->area_name }}" required>
                            </div>
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn btn-success me-2">Update Area</button>
