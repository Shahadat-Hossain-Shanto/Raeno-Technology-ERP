        ...
        <div class="container">
            <div class="card card-primary">
                <div class="card-header">
                    <h5><strong><i class="fas fa-map"></i> Add New Area</strong></h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('areas.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-2 col-lg-6">
                                ...
                                <input type="text" name="area_name" class="form-control" id="area_name" value="{{ old('area_name') }}" required>
                            </div>
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn btn-success me-2">Save Area</button>
