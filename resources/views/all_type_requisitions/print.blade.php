...
@section('title', 'Requisition Print')
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p><strong>Status:</strong>
                                {{ ucfirst($requisition->status == 0 ? 'Pending' : ($requisition->status == 1 ? 'Approved' : 'Canceled')) }}
                            </p>
                        </div>
                        ...
                        <div class="col-md-6 text-md-end">
                            ...
                            {{-- <div class="d-print-none">
                                <hr>
                                <p><strong>Credit Limit:</strong>  {{ $distributor->credit_limit }} </p>
                                <p><strong>Balance:</strong>  {{ $distributor->balance }} </p>
                            </div> --}}
                        </div>
                    ...
                    <p><strong>Account Note:</strong> {{ $requisition->accounts_approved_note }}</p>
                    <p><strong>Sales Note:</strong> {{ $requisition->sales_approved_note }}</p>

                    <!-- Back Button -->
                    <a href="{{ route('all-type-requisitions.index') }}" class="btn btn-secondary d-print-none">
