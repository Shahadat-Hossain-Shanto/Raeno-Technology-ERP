...
@section('title', 'RAENO :: Order Receivable')
    ...
    <div class="content">
        <div class="card card-primary">
            <div class="card-header d-flex justify-content-between" style="height: 49px;">
                <h5><strong><i class="fas fa-list-alt"></i> Order Receivable</strong></h5>
            </div>
        ...
        $('#receiveTable').DataTable({
            ...
            columns: [
                ...
                { data: 'quantity' },
                {
                    data: 'status',
                    render: function (data) {
                        // Since this is only for receivable (pending) data
                    ...
                    render: function (data, type, row) {
                        return `
                            <div class="d-flex justify-content-center">
                                <a href="/receive-order/${row.id}" class="btn btn-sm btn-primary" title="Receive" style="min-width: 90px;">
                                    Receive
                                </a>
                            </div>
                        `;
