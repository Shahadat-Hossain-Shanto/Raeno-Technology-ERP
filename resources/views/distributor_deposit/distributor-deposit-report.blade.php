...
@section('title', 'Distributor Deposit Report')
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h5 class="m-0"><strong><i class="fas fa-file-contract"></i>Distributor Deposit Report</strong></h5>
                            </div>
                            <div class="card-body">
                                <div id="form_div">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#customerReceiveReportForm').on('submit', function(e) {
                ...
                var voucher= 'Distributor Deposit';
               ...
               if (transaction_id !=''|| startdate.length != 0 && enddate.length != 0) {
                ...
                $.ajax({
                    type: "get",
                    url: "/distributor-deposit-report/"+transaction_id+"/"+startdate+"/"+enddate+"/"+voucher,

                    success: function(response) {
                        // console.log(response.distributor_deposit);
                        var totalDebit=0;
                        var totalCredit=0;
                        response.distributor_deposit.forEach(customer_receive => {
                        ...
                        i=1;
                        $('#tablePart').show();
                        onChangeDataTable(response.distributor_deposit,i)
