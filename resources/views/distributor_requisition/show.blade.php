                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-md-end">
                            ...
                            <p class="mb-1"><strong>ACC Approval:</strong> {{ ucfirst($requisition->accounts_approved_status == 0 ? 'Pending' : 'Approved') }}
                  ...
                  <form action="{{ route('distributor_requisition.action', $requisition->id) }}" method="POST">
                      @csrf
                      
                  
                      <div class="mt-3 d-flex justify-content-between align-items-center">
                          <a href="{{ route('distributor_requisition.index') }}" class="btn btn-secondary">
