...
//                 purchaseVoucher["transaction_type"]     = 'Expense Voucher';
		...
		voucherHeads: [
			{
				...
				amount: debitAmount,
		        transaction_type:'Expense By ' + creditHeadName,
				type: "debit"
			},
			{
				...
				amount: debitAmount,
		        transaction_type:'Expense ' + debitHeadName,
				type: "credit"
			}
		]
	};
